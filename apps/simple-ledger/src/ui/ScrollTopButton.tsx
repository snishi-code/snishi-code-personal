 ...
 * 各画面が </section> の直前に 1 行置く。下端の位置は --scroll-top-bottom（app.css の :root が
 * 正本）で決まり、全画面で固定フッターを避ける。記帳バーのあるホームだけ .dashboard が
 * さらに上へ押し上げる（fixed でもカスタムプロパティは DOM 祖先から継承される）。
