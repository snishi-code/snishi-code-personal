...
export const UI = {
  ...
  // CSV 取込（Import Profile・v8）。取込フロー + 決定済み一覧
  csvImport: {
    view: 'csvImport.view',
    tabFlow: 'csvImport.tab.flow',
    tabDecisions: 'csvImport.tab.decisions',
    // ファイル選択（隠し input + ボタン）と profile / 取込元の選択
    filePick: 'csvImport.file.pick',
    fileInput: 'csvImport.file.input',
    profile: 'csvImport.profile',
    source: 'csvImport.source',
    sourceAdd: 'csvImport.source.add',
    sourceEdit: 'csvImport.source.edit',
    setupOpen: 'csvImport.setup.open',
    // binding セットアップシート（§1-1b）
    setup: 'csvImport.setup',
    setupIdentity: 'csvImport.setup.identity',
    setupOwn: 'csvImport.setup.own',
    ...
    errorList: 'csvImport.error.list',
    // レビューキュー（行種グループ + 個別行）
    reviewList: 'csvImport.review.list',
    ...
    linkCandidate: 'csvImport.link.candidate',
    linkRow: 'csvImport.link.row',
    // 決定済み一覧（§4-6）
    ...
    statusIgnored: 'csvImport.decisions.status.ignored',
    decisionRow: 'csvImport.decisions.row',
    decisionOpenEntry: 'csvImport.decisions.openEntry',
    decisionRemove: 'csvImport.decisions.remove',
    removeConfirm: 'csvImport.decisions.removeConfirm',
    // プロファイル管理（§1-1: 一覧・削除・組み込み復元・JSON 貼付追加 / 表示コピー）
    tabProfiles: 'csvImport.tab.profiles',
    profilesList: 'csvImport.profiles.list',
    profileRow: 'csvImport.profiles.row',
    profileJsonOpen: 'csvImport.profiles.jsonOpen',
    profileDelete: 'csvImport.profiles.delete',
    profileDeleteConfirm: 'csvImport.profiles.deleteConfirm',
    profilesRestore: 'csvImport.profiles.restore',
    profilesPasteOpen: 'csvImport.profiles.pasteOpen',
    profileJsonSheet: 'csvImport.profiles.jsonSheet',
    profileJsonText: 'csvImport.profiles.jsonText',
    profileJsonCopy: 'csvImport.profiles.jsonCopy',
    pasteSheet: 'csvImport.profiles.pasteSheet',
    pasteTarget: 'csvImport.profiles.pasteTarget',
    pasteName: 'csvImport.profiles.pasteName',
    pasteJson: 'csvImport.profiles.pasteJson',
    pasteSave: 'csvImport.profiles.pasteSave',
    // AI プロファイルビルダー（§6: マスク付き開示 → 依頼文コピー → 返書検証 → 実適用プレビュー → 保存）
    builderOpen: 'csvImport.builder.open',
    builder: 'csvImport.builder',
    builderClose: 'csvImport.builder.close',
    builderFilePick: 'csvImport.builder.filePick',
    builderFileInput: 'csvImport.builder.fileInput',
    builderEncoding: 'csvImport.builder.encoding',
    builderDelimiter: 'csvImport.builder.delimiter',
    builderHeaderRow: 'csvImport.builder.headerRow',
    builderNote: 'csvImport.builder.note',
    builderMaskList: 'csvImport.builder.maskList',
    builderMaskMode: 'csvImport.builder.maskMode',
    builderPrompt: 'csvImport.builder.prompt',
    builderPromptCopy: 'csvImport.builder.promptCopy',
    builderReply: 'csvImport.builder.reply',
    builderCheck: 'csvImport.builder.check',
